...
$INPUT = '<input type="text" id="cer_certificacao" name="cer_certificacao" required maxlength="500" value="' . $certificacao_model['cer_certificacao'] .'">';
...
$INPUT = '<input type="text" id="cer_instituicao" name="cer_instituicao" required maxlength="500" value="' . $certificacao_model['cer_instituicao'] .'">';
echo $TR. $TD . $INPUT . $TD_ . $TR_;
...
$INPUT = '<input type="number" id="cer_ano_obtencao" name="cer_ano_obtencao" required min="1900" max="300000" value="' . $certificacao_model['cer_ano_obtencao'] .'">';
echo $TR. $TD . $INPUT . $TD_ . $TR_;
