...
$pessoa_model['usu_int_id'] = $_SESSION['usu_int_id'];
	...
	$pdf->Cell(0, 5, iconv('utf-8', 'iso-8859-1', $saida), 0, 1, 'L');
	$pdf->Ln(10);
	$saida = "Estado civil: ". $array_estado_civil[$pessoa_model['pes_int_estado_civil']];
	$pdf->Cell(0, 5, iconv('utf-8', 'iso-8859-1', $saida), 0, 1, 'L');
	$pdf->Ln(10);
	...
	$pdf->Cell(0, 5, iconv('utf-8', 'iso-8859-1', $saida), 0, 1, 'L');
	$pdf->Ln(10);
	$saida = "Último salário mensal (R$): ". $array_ultimo_salario[$pessoa_model['pes_int_ultimo_salario_mensal']];
	$pdf->Cell(0, 5, iconv('utf-8', 'iso-8859-1', $saida), 0, 1, 'L');
	$pdf->Ln(10);
	$saida = "Está empregado atualmente: ". $array_resposta[$pessoa_model['pes_bit_empregado_atualmente']];
	$pdf->Cell(0, 5, iconv('utf-8', 'iso-8859-1', $saida), 0, 1, 'L');
	$pdf->Ln(10);
	$saida = "Está porcurando emprego atualmente: ". $array_resposta[$pessoa_model['pes_bit_procurando_emprego_atualmente']];
	$pdf->Cell(0, 5, iconv('utf-8', 'iso-8859-1', $saida), 0, 1, 'L');
	$pdf->Ln(10);
	$saida = "Está disponível para viagem: ". $array_resposta[$pessoa_model['pes_bit_disponivel_viagens']];
	$pdf->Cell(0, 5, iconv('utf-8', 'iso-8859-1', $saida), 0, 1, 'L');
	$pdf->Ln(10);
