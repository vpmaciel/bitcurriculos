...
<body>
	...
	<div class="col-lg-12">
            ...
            <?= form_open('EmpresaController/GravarRegistro') ?>
            <?php
            ...
            $entrada = array(
                ...
                Constante::VALUE => set_value(Constante::RAZAO_SOCIAL, $razao_social),
            ...
            $entrada = array(
                ...
                Constante::VALUE => set_value(Constante::CONFIRMAR_SENHA, $senha),
                Constante::CLASSE => Constante::CLASSE_ENTRADA_VALUE,
                Constante::REQUIRED => 'true',
                Constante::MAXLENGTH => '10',
                Constante::STYLE => Constante::STYLE_WIDTH
