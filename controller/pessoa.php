...
if ($resultado == 0) {
    ...
    if ($_GET['a'] != 's') {
        ...
        $pessoa_json = selecionar('pessoa', $pessoa_model);
        ...
        foreach($pessoa_json as $registro) {            
            ...
            $pessoa_model['pes_int_escolaridade'] = $pes_int_escolaridade;
            $pessoa_model['pes_int_estado_civil'] = $pes_int_estado_civil;
        ...
        exit("oi");        
        header("location: ..\view\pessoa.php?pessoa_model[]=$pessoa_model");
    }
